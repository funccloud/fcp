...
func newTestProxy(t *testing.T) *fakeProxy {
	...
	subjectAccessReview := subjectaccessreview.New(fakeClient)
...
func TestHandlers(t *testing.T) {
	...
	tests := map[string]struct {
		...
		"an authed request with authorized impersonation user should succeed": {
			...
			expExtra: map[string][]string{
				"Impersonate-Extra-Originaluser.funccloud.com-User":   {"mmosley"},
				"Impersonate-Extra-Originaluser.funccloud.com-Groups": {"group1"},
			},
			expBody: "",
		},
		...
		"an authed request with authorized impersonation extra should succeed": {
			...
			expExtra: map[string][]string{
				...
				"Impersonate-Extra-Originaluser.funccloud.com-User":   {"mmosley"},
				"Impersonate-Extra-Originaluser.funccloud.com-Groups": {"group1"},
				"Impersonate-Extra-Originaluser.funccloud.com-Extra":  {"{\"someextra\":[\"someval1\",\"someval2\"],\"someextra2\":[\"foo\",\"bar\"]}"},
			},
			expBody: "",
		},
